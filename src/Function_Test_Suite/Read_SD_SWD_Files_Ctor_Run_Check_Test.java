		...
		try {
			...
			for(File file: files){
				...
				for(int index=0; index<size;index++){
					...
					System.out.print("Dew Point:"+info.getDew_Point()+"\tSolar Rad:"+info.getSolar_Rad()+"\tRainfall:"+info.getRainfall());
				    ...
				    //WIND 
					System.out.print("Wind Dir:"+info.getWind_Dir()+"\tWind Gust:"+info.getWind_Gust()+"\tWind Speed:"+info.getWind_Speed());
					//humidity
